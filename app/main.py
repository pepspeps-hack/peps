...
app.secret_key = 'your_very_secret_key_for_luxewatch'  # Important for session management

# --- Context Processors ---
@app.context_processor
def inject_script_load_time():
    return {'SCRIPT_LOAD_TIME': datetime.datetime.utcnow()}

@app.template_filter('sum_quantities')
def sum_quantities_filter(cart_items):
...
PRODUCTS = {
    1: {"id": 1, "name": "ChronosMaster Prestige", "brand": "Horologique", "price": 12500.00, "description": "A masterpiece of Swiss engineering, featuring a self-winding mechanical movement and a sapphire crystal case. Water-resistant up to 100 meters.", "image_url": "placeholder_div", "specifications": {"Case Material": "Stainless Steel", "Movement": "Automatic", "Dial Color": "Black", "Strap": "Leather"}},
    2: {"id": 2, "name": "Aetheria Diamond", "brand": "Celestia", "price": 28750.00, "description": "Exquisite ladies' watch adorned with ethically sourced diamonds. Features a mother-of-pearl dial and a delicate rose gold bracelet.", "image_url": "placeholder_div", "specifications": {"Case Material": "18k Rose Gold", "Movement": "Quartz", "Dial Color": "Mother of Pearl", "Strap": "Rose Gold Bracelet", "Gemstones": "Diamonds"}},
    3: {"id": 3, "name": "Titanium Sport X1", "brand": "Valiant", "price": 7800.00, "description": "Robust and lightweight sports watch, crafted from aerospace-grade titanium. Includes chronograph functions and a durable rubber strap.", "image_url": "placeholder_div", "specifications": {"Case Material": "Titanium", "Movement": "Chronograph Quartz", "Dial Color": "Blue", "Strap": "Rubber", "Water Resistance": "200m"}},
    4: {"id": 4, "name": "Regal Classic", "brand": "Monarch", "price": 9950.00, "description": "Timeless design with a vintage appeal. Features a guilloché dial, Roman numerals, and a polished stainless steel case.", "image_url": "placeholder_div", "specifications": {"Case Material": "Stainless Steel", "Movement": "Manual Wind", "Dial Color": "Silver", "Strap": "Alligator Leather"}},
}
